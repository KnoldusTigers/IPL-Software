...
public class PlayerService {
     ...
     */
    public PlayersModel get(final String Id) {
     ...
     */
    @Transactional
    public Optional<PlayersModel> findByPlayersplayer_name(final String playername) {
     ...
     * @return the boolean
     */
    public boolean playernameExists(final String playername) {
