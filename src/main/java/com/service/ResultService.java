...
public class ResultService {
     ...
     */
    public MatchModel getResult(final MatchModel matchModel) {
        final Long teamId1 = matchModel.getTeam1().getId();
        final Long teamId2 = matchModel.getTeam2().getId();
        ...
        final String team1 =  matchModel.getTeam1Description();
        final int team1Score = Integer.parseInt(team1);
        final String team2 = matchModel.getTeam2Description();
        final int team2Score = Integer.parseInt(team2);
        final String wicket2 = matchModel.getTeam2Wickets();
        final int  team2wicket = Integer.parseInt(wicket2);
